    ...
    >
      ...
      max-w-7xl mx-auto">
        ...
        >
          ...
          font-bold cursor-pointer flex">Abel &nbsp;|
          <span className="sm:block hidden">&nbsp; Mrong</span>
          </p>
        </Link>
        ...
        justify-end item-center">
          ...
          <div className={`${!toggle ? 'hidden' :'flex'} p-6 black-gradient absolute top-20 right-0 mx-4 y-2 
